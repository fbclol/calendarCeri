...
//$grid->addColumn("export_url", "url export", "string");
//$grid->addColumn("optgroup", "optgroup", "string");
//$grid->addColumn("optdescription", "description", "string");
////$grid->addColumn("optdescription", "HEIGHT", "double(m,2)", null, true, null, false);
//
...
////$grid->addColumn("optgroup", "AGE", "integer");
////$grid->addColumn("optdescription", "HEIGHT", "double(m,2)", null, true, null, false);
...
////}
//
//$oBuilderFormation = new BuilderFormation("./listFormations.json");
//$data = $oBuilderFormation->aFormations;
//
//// render XML or JSON
